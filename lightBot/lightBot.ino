...
String ssid = "qicol";     // REPLACE mySSID WITH YOUR WIFI SSID
String pass = "12345678"; // REPLACE myPassword YOUR WIFI PASSWORD, IF ANY
String token = "6109506075:AAFNmUK5-TgRSpUjItjxzNCtZnoDmPusUMc";   // REPLACE myToken WITH YOUR TELEGRAM BOT TOKEN
uint8_t led = 0;            // the onboard ESP8266 LED.    
